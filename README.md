...
Low Level Design problems, SOLID principles, and design patterns, solved in C#.

## Structure
- `src/Solid_Principles/` — one file per SOLID principle, each contrasting a "before" (violating) version with an "after" (fixed) version
- `src/Common_Design_Patterns/` — common design patterns grouped by category (e.g. `Behavioral_Design_Patterns/`)
- `docs/` — templates and notes, including [SOLID Principles & Design Patterns](docs/Desgin_Patterns.md)
